                            ...
                            @foreach ($categories as $category)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <div class="btn-group">
                                            <a href="{{route('category.edit', $category->id)}}" class="btn btn-sm btn-success"><i class="fa fa-pencil"></i></a>
                                            <button type="button" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#eliminar_category-{{$category->id}}"><i class="fa fa-trash"></i>
                                        </div>
                                    </td>
                                </tr>
                                <div class="modal modal-danger fade" id="eliminar_category-{{$category->id}}" style="display: none;">
