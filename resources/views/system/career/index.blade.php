                            ...
                            @foreach ($careers as $career)    
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <div class="btn-group">
                                            <a href="{{route('career.edit', $career->id)}}" class="btn btn-sm btn-success"><i class="fa fa-pencil"></i></a>
                                            <button type="button" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#eliminar_career-{{$career->id}}"><i class="fa fa-trash"></i>
                                        </div>
                                    </td>
                                </tr>
                                <div class="modal modal-danger fade" id="eliminar_career-{{$career->id}}" style="display: none;">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                <form class="" action="{{route('career.destroy', $career->id)}}" method="post">
